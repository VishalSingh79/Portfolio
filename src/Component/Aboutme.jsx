    ...
    <div className='aboutsec' id='about-sec'>
        ...
        <div className='aboutsec-details'>
            ...
            <div className='right-about'   onMouseEnter={(event)=>cursorinc(event)}  onMouseLeave={(event)=>cursordec(event)}>
                 ...
                 > 
                 I'm a <span style={{color:"#14f7ff",fontWeight:"bold"}}>React Native and MERN Developer</span> with expertise in React Native, MongoDB, Express.js, ReactJS, SQL and Node.js and a solid foundation in C, C++, and Python.</p> 
                 <p className='right-desc' >With strong skills in problem-solving and Data Structures & Algorithms (DSA), I create responsive, high-performance applications focused on user experience. Driven by continuous learning, I’m eager to bring innovative, impactful projects to life.</p>
                 <div className='links'>
                 ...
                 <a href='mailto:singhvishal686030@gmail.com' target='_blank'><MdEmail className='link' style={{fontSize:"30px",color:"#14f7ff"}}/></a>
